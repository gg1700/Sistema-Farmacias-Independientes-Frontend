  ...
  return (
    <>
      <div className="flex items-center gap-9 p-4 m-10 hover:scale-105 transition-transform group">
        <button className="bg-modals shadow-md p-2 size-24 flex items-center justify-center rounded-full group-hover:bg-[#82d9b6] group-hover:scale-105 group-hover:cursor-pointer transition-transform">
          {children}
        </button>
